...
rent_burden_2015 <- rent_burden_2015 %>% mutate(gem_inkomen_per_maand = gem_inkomen * 1000 / 12)
...
huur_long$jaar <- NULL
huur_long$stadsdeel
rent_burden_2015 <- rent_burden_2015 %>% full_join(huur_long, by = "stadsdeel")

rent_burden_2015 <- rent_burden_2015 %>% mutate(Rent_burden = huurprijs / gem_inkomen_per_maand * 100)
