...
How does rent burden vary across neighbourhoods in Amsterdam West vs. Zuid?

```{r Choropleth Maps: Rent Burden by Neighbourhood 2017}
library(dplyr)
library(ggplot2)
library(viridis)
...
```{r Choropleth Maps: Rent Burden by Neighbourhood 2019}
...
```{r Boxplot of Rent Burden per Neighbourhood (Wijk) for 2017 and 2019}
