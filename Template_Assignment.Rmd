...
Variable 1: Rent burden For the temporal analysis we used rent burden per borough. Therefore we used the averages we calculated.
...
```{r gen_var1_rent_burden_per_neighborhood, include=FALSE}
...
```{r Multiline_plot_of_Rent_Burden_over_time_for_West_and_Zuid, include=FALSE}
...
```{r Choropleth_Maps_Rent_Burden_by_neighborhood_2017, include=FALSE}
library(dplyr)
library(ggplot2)
library(viridis)
...
```{r Choropleth_Maps_Rent_Burden_by_neighborhood_2019, include=FALSE}
...
```{r Boxplot_of_Rent_Burden_per_neighborhood_or_2017_and_2019, include=FALSE}
library(ggplot2)
library(dplyr)
...
```{r Line_Plot_of_Affordability_Pressure_Index_with_Airbnb_Cap_Annotation, include=FALSE}
library(dplyr)
library(ggplot2)
